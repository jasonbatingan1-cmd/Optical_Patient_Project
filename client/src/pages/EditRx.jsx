...
export default function EditRx() {
    ...
    // Load existing Rx + dropdown options
    useEffect(() => {
        async function load() {
            // Load existing Rx
            ...
            if (r) {
                ...
                setForm({
                    ...
                    od_axis: r.od_axis || "",
                    od_add: r.od_add || "",
                    od_prism_h: r.od_prism_h || "",
                    od_prism_v: r.od_prism_v || "",
                    os_sph: r.os_sph || "",
                    os_cyl: r.os_cyl || "",
                    os_axis: r.os_axis || "",
                    os_add: r.os_add || "",
                    os_prism_h: r.os_prism_h || "",
                    os_prism_v: r.os_prism_v || "",
                    pd_single: r.pd_single || "",
                    pd_od: r.pd_od || "",
                    pd_os: r.pd_os || "",
                    lensType: r.lensType || "",
                    coating: r.coating || "",
    ...
    async function save() {
        await apiPut(`/rx/${rxId}`, form);
        nav(`/patients/${id}/rx`);
    }

    return (
        <div style={{ padding: "2rem" }}>
            <button onClick={() => nav(`/patients/${id}/rx`)} className="btn-outline">
